...
#        return {}
        ...
        with st.container(border=True):
            ...
            with st.expander(label=":orange[Last Workitem]", expanded=False):
                with st.container():
                    ...
                    st.session_state.df_out['REFDATE'] = st.session_state.df_out['REFDATE'].strftime('%Y-%m-%d')#.dt.date  # Convert to date objects            
    ...
    if 'form_reset' in st.session_state and st.session_state.form_reset:
        ...
        st.session_state.tdsp_form = t.session_state.selected_tdsp_code
